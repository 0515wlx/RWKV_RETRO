...
#
python train.py --load_model "RWKV-LM/RWKV-v7/train_temp/out/L8-D512-x070/rwkv-204.pth" --wandb "Test" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --train_stage 3 --epoch_count 999999 --epoch_begin 0 --review_base_range 3 \
 --data_file "data/minipile" --my_exit_tokens 14982262070 --magic_prime 1371569 \
